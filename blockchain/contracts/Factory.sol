...
contract Factory {
        ...
        payable
    {
        ...
        Commission newCommission = (new Commission){value: msg.value}(
            msg.sender,
            msg.value,
            prompt,
            _minTime,
    ...
    function _entrySubmitted(string memory _ipfsPath, address _author)
        external
        commissionOnly
    {
    ...
    function _winnerChosen(address _winningAuthor, uint256 _reward)
        external
        commissionOnly
    {
    ...
    function _winnerTipped(address _winningAuthor, uint256 _amount)
        external
        commissionOnly
    {
    ...
    function _commissionerTipped(address _commissioner, uint256 _amount)
        external
        commissionOnly
    {
